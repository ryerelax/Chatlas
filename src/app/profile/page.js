  ...
  return (
    <div className="min-h-screen bg-[#F7F9FB] py-10 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <Link
          href="/wishlist"
          className="group relative bg-gradient-to-br from-[#E6F7F0] to-white border-2 border-[#E6F7F0] rounded-xl p-5 text-center hover:border-[#006C56] hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
        >
          ...
          <p className="text-[#65748A] text-sm">3 items saved</p>
        ...
        >
          ...
          <p className="text-[#65748A] text-sm">5 items saved</p>
    ...
    >
      ...
      <p className="text-[#65748A] text-sm">12 reviews written</p>
    ...
    >
      ...
      <p className="text-[#65748A] text-sm">8 photos uploaded</p>
    ...
    >
      ...
      <p className="text-[#65748A] text-sm">6 attractions</p>

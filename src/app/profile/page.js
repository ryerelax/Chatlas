      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-[#D8E1E7] p-6 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <Link href="/wishlist" className="group relative bg-gradient-to-br from-[#E6F7F0] to-white border-2 border-[#E6F7F0] rounded-xl p-5 text-center hover:border-[#006C56] hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="w-14 h-14 mx-auto rounded-full bg-[#006C56] flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="mt-3 text-[#006C56] text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                View →
              </div>
            </Link>

            <Link href="/favourites" className="group relative bg-gradient-to-br from-[#FFF3D6] to-white border-2 border-[#FFF3D6] rounded-xl p-5 text-center hover:border-[#FFAB00] hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            ...
            <Link href="/reviews" className="group relative bg-gradient-to-br from-[#EAF3FA] to-white border-2 border-[#EAF3FA] rounded-xl p-5 text-center hover:border-[#2F6DA1] hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            ...
            <Link href="/photos" className="group relative bg-gradient-to-br from-[#F3F0FF] to-white border-2 border-[#F3F0FF] rounded-xl p-5 text-center hover:border-[#7C3AED] hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            ...
            <Link href="/travel-history" className="group relative bg-gradient-to-br from-[#E8F7EF] to-white border-2 border-[#E8F7EF] rounded-xl p-5 text-center hover:border-[#16845B] hover:shadow-lg hover:-translate-y-1 transition-all duration-300">

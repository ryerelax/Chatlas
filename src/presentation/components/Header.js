    ...
    <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 shadow-sm backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <nav className="hidden items-center gap-2 md:flex" aria-label="Main navigation">
          ...
          <Link href="/exploration-map" className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-emerald-50 hover:text-emerald-700">Map</Link>
        ...
        <details className="relative md:hidden">
          ...
          <nav className="absolute right-0 mt-3 w-56 rounded-xl border border-gray-200 bg-white p-3 shadow-lg" aria-label="Mobile navigation">
            ...
            <Link href="/exploration-map" className="block rounded-lg px-4 py-3 text-sm font-semibold text-gray-700 hover:bg-emerald-50 hover:text-emerald-700">Map</Link>
